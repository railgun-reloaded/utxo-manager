 ...
 */
function applyNullifiers (state: UTXOState, nullifiers: string[]): UTXOState {
 ...
 */
function getUTXO (state: UTXOState, commitment: string): UTXO | undefined {
 ...
 */
function getSpendableUTXOs (state: UTXOState, token?: string): UTXO[] {
 ...
 */
function isSpent (state: UTXOState, nullifier: string): boolean {
